...
@Controller
@RequestMapping(value = "/loadcpu")
public class CpuLoadController {
    private static final Logger logger = LoggerFactory.getLogger(CpuLoadController.class);
    private AlbumRepository repository;

    @Autowired
    public CpuLoadController(AlbumRepository repository) {
